        ...
        <div class="flex flex-col">
            <div class="relative items-start shadow grid grid-cols-3 justify-between z-30">
                <div class="p-8 flex inline-flex text-gray-50 items-center invisible sm:visible">
                    <a href="https://en.epuertotravelperu.com"><img src="{{asset('images/iconos/reino-unido.png')}}" alt="" class="w-9 ml-3"></a>
            ...
            <div class="items-center bg-primary bg-opacity-80 py-4 px-24 justify-center md:flex toggle hidden z-30">
                <div class="flex flex-col md:flex-row lg:mx-6 md::gap-0 gap-2">
                    ...
                    <a class="text-gray-50 my-1 text-sm font-medium dark:text-gray-200 hover:text-secondary dark:hover:text-indigo-400 md:mx-4 md:my-0 transform hover:-translate-x-2 transition duration-500 ease-in-out" href="/en-tours">Top Cusco Tours</a>
        ...
        <div class="bg-footer-texture bg-repeat-x bg-12 top-0 w-full z-30 p-12">
            <div class="grid md:grid-cols-3 grid-cols-1 gap-8">
                <div class="text-white">
                    ...
                    <p class="p-5 text-sm">Tu próxima aventura está a un clic de distancia.<p>
